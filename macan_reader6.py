...
class MacanReader(QMainWindow):
    ...
    def handle_paint_request(self, printer):
        ...
        for i, page_idx in enumerate(pages_to_print):
            ...
            # --- FIX: Changed printer.pageRect(QPrinter.Unit.Pixel) to printer.pageRect() ---
            # The QPrinter.Unit enum does not have a 'Pixel' attribute.
            # Calling pageRect() without arguments returns the drawable area in the
            # correct coordinate system for the painter.
    ...
    def show_help_content(self):
        ...
        <h3>File</h3>
        <ul>
            <li><b>Open (Ctrl+O):</b> Open a new PDF file.</li>
