...
class MacanReader(QMainWindow):
    ...
    def handle_paint_request(self, printer):
        ...
        # --- PERBAIKAN 1: Menggunakan printRange() dan enum QPrinter.PrintRange ---
        print_range_setting = printer.printRange() # DIUBAH: dari pageRange()
        from_page = printer.fromPage()
        to_page = printer.toPage()
        
        pages_to_print = list(range(len(self.pdf)))

        # DIUBAH: Menggunakan enum QPrinter.PrintRange
        if print_range_setting == QPrinter.PrintRange.PageRange:
            # fromPage/toPage adalah 1-based, list index adalah 0-based
    ...
    # DITAMBAHKAN: Dialog Bantuan (Help Content)
    # --- PERBAIKAN 2: Menggunakan QScrollArea agar bisa di-scroll ---
    def show_help_content(self):
        ...
        <h3>Navigasi</h3>
        <ul>
            <li><b>Halaman Berikutnya:</b> Klik tombol panah 'Next' atau tekan tombol <b>Panah Kanan</b>.</li>
            <li><b>Halaman Sebelumnya:</b> Klik tombol panah 'Previous' atau tekan tombol <b>Panah Kiri</b>.</li>
            <li><b>Pergi ke Halaman:</b> Klik thumbnail di panel sebelah kiri.</li>
        </ul>

        <h3>Zooming & Panning</h3>
        <ul>
            <li><b>Zoom In/Out:</b> Gunakan tombol <b>+</b> dan <b>-</b>, slider di status bar, atau <b>Ctrl+</b>/<b>Ctrl-</b>.</li>
            <li><b>Reset Zoom:</b> Klik ikon 'target' atau tekan <b>Ctrl+0</b> untuk reset zoom ke 100%.</li>
            <li><b>Pan (Geser):</b> Klik ikon 'Tangan' untuk masuk mode Pan. Klik dan seret halaman untuk menggeser tampilan. Klik ikon lagi untuk keluar.</li>
        </ul>

        <h3>File</h3>
        <ul>
            <li><b>Open (Ctrl+O):</b> Membuka file PDF baru.</li>
            <li><b>Save As:</b> Menyimpan salinan PDF yang sedang dibuka.</li>
            <li><b>Print (Ctrl+P):</b> Membuka pratinjau cetak (print preview) untuk mencetak dokumen.</li>
            <li><b>Export As:</b> Ekspor semua halaman dokumen sebagai gambar PNG atau sebagai gambar di dalam file DOCX.</li>
            <li><b>Recent Files:</b> Membuka file yang baru-baru ini dilihat.</li>
        </ul>
        
        <h3>Pencarian (Ctrl+F)</h3>
        <ul>
            <li>Ketik kata kunci di bar 'Find' di bagian atas.</li>
            <li>Klik <b>Next</b> atau <b>Previous</b> untuk menavigasi hasil.</li>
            <li>Centang <b>Match Case</b> untuk pencarian sensitif huruf besar/kecil.</li>
            <li>Hasil saat ini disorot dengan warna oranye; hasil lainnya berwarna kuning.</li>
        </ul>

        <h3>Thumbnails</h3>
        <ul>
            <li><b>Tampil/Sembunyi:</b> Gunakan <b>Window > Show Thumbnail Pane</b> atau tombol 'X' di panel.</li>
            <li><b>Menu Konteks:</b> Klik kanan pada thumbnail untuk mengekspor halaman spesifik tersebut sebagai PDF, PNG, atau DOCX.</li>
        </ul>

        <h3>Themes</h3>
        <ul>
            <li>Ubah tampilan aplikasi dari menu <b>Themes</b>. Pilihan Anda akan disimpan.</li>
        </ul>
        """
        ...
        # Set teks dummy agar layoutnya dibuat
        help_dialog.setText(" ") 
        
        # Buat QScrollArea
        scroll_area = QScrollArea(help_dialog)
        scroll_area.setWidgetResizable(True)
        scroll_area.setMinimumSize(500, 300) # Atur ukuran minimum
        
        # Buat QLabel untuk menampung teks
        help_label = QLabel(help_text, scroll_area)
        help_label.setTextFormat(Qt.TextFormat.RichText)
        help_label.setWordWrap(True)
        help_label.setAlignment(Qt.AlignmentFlag.AlignTop)
        
        # Masukkan QLabel ke dalam QScrollArea
        scroll_area.setWidget(help_label)
        
        # Ambil layout QGridLayout dari QMessageBox
        layout = help_dialog.layout()
        
        # Hapus widget dummy (QLabel) di posisi (0, 1)
        old_widget = layout.itemAtPosition(0, 1).widget()
        if old_widget:
            old_widget.deleteLater()
            
        # Tambahkan QScrollArea kita ke posisi (0, 1)
