...
# DITAMBAHKAN: Import Signal untuk komunikasi antar widget
from PySide6.QtCore import Qt, QSize, QSettings, QUrl, QByteArray, Signal
...
# (Bagian SVG_ICONS tidak diubah, jadi disembunyikan untuk keringkasan)
SVG_ICONS = {
...
class ThumbnailLabel(QLabel):
    ...
    # DITAMBAHKAN: Definisikan sinyal yang akan membawa integer (nomor halaman)
    ...
    def mousePressEvent(self, event):
        # DIUBAH: Pancarkan sinyal page_clicked daripada memanggil parent secara berantai
...
class MacanReader(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Anda mungkin perlu membuat file icon.ico atau hapus baris ini
    ...
    # (Fungsi create_actions, create_menus, create_toolbar, create_status_bar, dll tidak berubah)
    ...
    def open_pdf(self, file_path):
        try:
            ...
            # DIUBAH: panggil go_to_page untuk memastikan highlight thumbnail juga diterapkan
    ...
    def populate_thumbnails(self):
        ...
        for i in range(len(self.pdf)):
            ...
            # DIUBAH: Hubungkan sinyal dari thumbnail ke slot go_to_page
    ...
    def print_file(self):
        ...
        if dialog.exec() == QPrintDialog.DialogCode.Accepted:
            ...
            for i in range(len(self.pdf)):
                page = self.pdf[i]
                img = page.render(scale=printer.resolution()/72.0).to_pil()
                # DIUBAH: Menghapus .rgbSwapped() juga di sini untuk print
